            ...
            {type === 'login' && (
                <div className="flex flex-col items-center justify-center w-full gap-[10px]">
                    ...
                    <div className="flex items-center w-full justify-between ">
                        <Button onClick={() => window.location.href = 'https://smarttech-367cffc9dc63.herokuapp.com/login/oauth2/code/facebook'} className="bg-[#23085A] w-[130px] text-white cursor-pointer"><FacebookIcon /> Facebook</Button>
                        <Button onClick={() => window.location.href = 'https://smarttech-367cffc9dc63.herokuapp.com/login/oauth2/code/google'} className="bg-[#23085A] w-[130px] text-white cursor-pointer"><GoogleIcon /> Google</Button>
                    </div>
                </div>
            ) }
            {(type === 'registry' || 'login') && (
