...
function Category({isWrapped = false}: CategoryProps): React.ReactNode {
    return ( 
        <div className={cn(`flex h-[590px] w-[1290px] bg-white rounded-tl-[80px] rounded-br-[80px] mb-[50px] `, isWrapped ? 'flex-row-reverse' : '')}>
            <div className="flex-1 h-full">
                <img 
                    ...
                    className={cn("w-full h-full object-conver rounded-tl-[50px]", isWrapped ? 'rounded-br-[80px] !rounded-tl-[0px]' : '')}
                />
            </div>
