...
function SourcesCourses(data: Component1): React.ReactNode {
    return ( 
        <Link className="w-[300px] h-[345px] flex-col flex bg-white flex items-center justify-center rounded-tl-[30px] rounded-br-[30px]" href={data.slug}>
            <div className="flex-1 w-full rounded-tl-[30px]">
                <img 
                    src={data.srcImage}
                    alt="Sources Courses"
            ...
            <div className="p-[15px] flex flex-col items-center justify-center flex-1">
                <div className="flex-1 text-[#23085A] text-[20px] font-bold hover:underline hover:text-[#00953B] decoration-[#00953B] ">
                    {data.title}
                </div>
